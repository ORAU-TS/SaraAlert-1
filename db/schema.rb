...
ActiveRecord::Schema.define(version: 2021_03_23_190904) do
  ...
  create_table "buildings", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["jurisdiction_id"], name: "index_buildings_on_jurisdiction_id"
  end
  ...
  create_table "custom_messages", charset: "utf8", force: :cascade do |t|
    t.string "subject"
    t.text "body"
    t.integer "message_type"
    t.bigint "jurisdiction_id"
    t.string "recipients"
    t.index ["jurisdiction_id"], name: "index_custom_messages_on_jurisdiction_id"
  end
  ...
  create_table "jurisdiction_emails", charset: "utf8", force: :cascade do |t|
    t.string "domain"
    t.bigint "jurisdiction_id", null: false
  ...
  create_table "patients", charset: "utf8", force: :cascade do |t|
    ...
    t.string "saa_student_id"
    t.string "saa_building_name"
    t.integer "saa_floor_number"
    t.string "saa_room_number"
    t.boolean "head_of_household"
    t.string "department"
    t.string "supervisor"
    t.string "project"
    t.datetime "saa_last_day_at_work"
  ...
  create_table "potential_patients", charset: "utf8", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "email"
    t.boolean "exposed"
    t.boolean "tested_positive"
    t.boolean "concerning_symptoms"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "assessment"
    t.index ["jurisdiction_id"], name: "index_potential_patients_on_jurisdiction_id"
  end
  ...
  add_foreign_key "buildings", "jurisdictions"
  add_foreign_key "jurisdiction_emails", "jurisdictions"
