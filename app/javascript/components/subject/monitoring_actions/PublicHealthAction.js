  ...
  createModal(toggle, submit) {
    return (
      <Modal size="lg" show centered onHide={toggle}>
        ...
        <Modal.Body>
          <p>
            Are you sure you want to change latest action to &quot;{this.state.public_health_action}&quot;?
            ...
            <React.Fragment>
              ...
              <Form.Group>
                {this.state.apply_to_household && this.props.patient.monitoring && (
                  <i>
                    If any household members are being monitored in the exposure workflow, those records will appear on the PUI line list if any action other
                    than &quot;None&quot; is selected above. If any household members are being monitored in the isolation workflow, this update will not impact
                    the line list on which those records appear.
                  </i>
                )}
              </Form.Group>
            </React.Fragment>
