...
class MoveToHousehold extends React.Component {
  ...
  /*line up columns on settings page
   line up checkboxes in modal
   move checkboxes to front
   when patient gets created, show the send notification modal
   */

  createModal() {
    return (
      <Modal dialogClassName="modal-move-household" show centered>
        <Modal.Header>
