...
import PotentialPatientsTable from './PotentialPatientsTable';

class SelfEnrollWorkflow extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      jurisdiction_paths: {},
...
export default SelfEnrollWorkflow;
