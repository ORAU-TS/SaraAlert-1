  ...
  if (httpStatus) {
    ...
    switch (httpStatus) {
      ...
      case 403:
        ...
        break;
      case 404:
        errorExplanationString += 'Failed to communicate with the Sara Alert Academic Server (Error 404).';
        break;
      case 422:
        errorExplanationString += 'Unprocessable entity (Error 422).';
        break;
      case 500:
        errorExplanationString += 'An error occurred on the Sara Alert Academic Server (Error 500).';
        break;
      case 504:
