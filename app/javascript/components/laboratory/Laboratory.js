...
class Laboratory extends React.Component {
  constructor(props) {
    ...
    this.state = {
      showModal: false,
      loading: false,
      location: this.props.lab.location || '',
      ...
      <Modal size="lg" show centered onHide={toggle}>
        ...
        <Modal.Body>
          <Form>
            ...
            <Row>
              <Form.Group as={Col}>
                <Form.Label className="nav-input-label">Location</Form.Label>
                <Form.Control
                  size="lg"
                  id="location"
            ...
            {console.log('Loading specimen_colletion')}
            <Row>
              <Form.Group as={Col}>
