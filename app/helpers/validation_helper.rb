...
module ValidationHelper # rubocop:todo Metrics/ModuleLength
  ...
  VALIDATION = {
    ...
    location: { label: 'Location', checks: [] },
    saa_floor_number: { label: 'Floor Number', checks: [:integer] },
    assigned_user: { label: 'Assigned User', checks: [] },
    vaccinated: { label: 'Vaccinated', checks: [:bool] },
    disease: { label: 'Disease', checks: [] },
    vac_type: { label: 'Vac Type', checks: [] },
    lot_number: { label: 'Lot Number', checks: [] },
    first_vac_date_1: { label: 'Vac 1 First Vac Date', checks: [:date] },
    second_vac_date_1: { label: 'Vac 1 Second Vac Date', checks: [:date] },
    second_vac_date_2: { label: 'Vac 2 First Vac Date', checks: [:date] },
    first_vac_date_2: { label: 'Vac 2 Second Vac Date', checks: [:date] },
  }.freeze
